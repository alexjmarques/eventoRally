...
<div class=\"col-md-12 title-evento\"><div class=\"group\"><h4>Detalhes da Inscrição</h4></div><p class=\"text-right\">Evento: {{ evento.titulo }} | {{ evento.data ? evento.data|date('d/m/Y') : '' }} </p></div>
