...
class __TwigTemplate_a1b0508ce734d4452cee0abaa62db54b990c29a7250345fdcff340d7be5e5d9b extends \Twig\Template
{
    private $source;
...
<div class=\"col-md-12 \">
    <table class=\"table table-striped table-bordered dataTable\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["clientes"]) || array_key_exists("clientes", $context) ? $context["clientes"] : (function () { throw new RuntimeError('Variable "clientes" does not exist.', 24, $this->source); })()));
...
";
    ...
    {
        return array (  149 => 38,  140 => 34,  131 => 30,  127 => 29,  123 => 28,  119 => 27,  113 => 26,  110 => 25,  105 => 24,  86 => 7,  84 => 6,  75 => 5,  57 => 3,  27 => 1,);
    }
...
<div class=\"col-md-12 \">
    <table class=\"table table-striped table-bordered dataTable\">
        ...
        {% for cliente in clientes %}
            <tr>
                <td><a href=\"{{ path('cliente_show', {'id': cliente.id}) }}\">{{ cliente.nome }}</a></td>
                <td>{{ cliente.email }}</td>
                <td>{{ cliente.cpf }}</td>
                <td>{{ cliente.cnh }}</td>
...
{% endblock %}
", "cliente/index.html.twig", "/var/www/html/evento/templates/cliente/index.html.twig");
    }
}
