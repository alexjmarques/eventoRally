...
// Returns the private 'App\Repository\UsuarioEventoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UsuarioEventoRepository.php';

return $this->privates['App\Repository\UsuarioEventoRepository'] = new \App\Repository\UsuarioEventoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
