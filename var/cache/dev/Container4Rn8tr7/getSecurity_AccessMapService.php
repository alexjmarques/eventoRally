...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/cliente/new'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/comprar'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/checkout/notification/retorno'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
