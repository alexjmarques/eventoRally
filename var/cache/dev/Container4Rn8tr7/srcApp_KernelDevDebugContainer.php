...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ClienteSecurityController' => 'getClienteSecurityControllerService.php',
            'App\\Controller\\EventoController' => 'getEventoControllerService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/EventSubscriber/CadastroSubscriber.php';
            ...
            include_once $this->targetDirs[3].'/src/Twig/PagSeguroExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Vp-pQH5BWR', 0, ($this->targetDirs[0].'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HLKGejW4ye', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => function () {
            return ($this->privates['App\EventSubscriber\CadastroSubscriber'] ?? $this->getCadastroSubscriberService());
        }, 1 => 'onKernelRequest'], 0);
        $instance->addListener('kernel.request', [0 => function () {
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\PagSeguroExtension());
        ...
        $instance->addGlobal('PAGSEGURO_JS', $this->getEnv('PAGSEGURO_JS'));
    ...
    /**
     * Gets the private 'App\EventSubscriber\CadastroSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\CadastroSubscriber
     */
    protected function getCadastroSubscriberService()
    {
        return $this->privates['App\EventSubscriber\CadastroSubscriber'] = new \App\EventSubscriber\CadastroSubscriber(($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.helper'] ?? $this->getSecurity_HelperService()));
    }
    ...
    {
        return $this->privates['App\EventSubscriber\LoginSubscriber'] = new \App\EventSubscriber\LoginSubscriber(($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.helper'] ?? $this->getSecurity_HelperService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QAJ5HKxGwi', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tA61tmn7M+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0WCBKFuWcS', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hRNRsSQ4fT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'pt-BR', ($this->services['router'] ?? $this->getRouterService()));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', 'cliente_logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'PAGSEGURO_URL_RETORNO': $value = $this->getEnv('PAGSEGURO_URL_RETORNO'); break;
            case 'evento_dir': $value = ($this->targetDirs[3].'/public/uploads/eventos'); break;
