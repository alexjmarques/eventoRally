...
// Returns the private 'App\Repository\DadosVeiculoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DadosVeiculoRepository.php';

return $this->privates['App\Repository\DadosVeiculoRepository'] = new \App\Repository\DadosVeiculoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
