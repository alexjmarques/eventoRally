...
// Returns the private 'App\Repository\DadosMedicosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DadosMedicosRepository.php';

return $this->privates['App\Repository\DadosMedicosRepository'] = new \App\Repository\DadosMedicosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
