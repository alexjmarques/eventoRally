...
// Returns the private 'App\Repository\DadosProfissionaisRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DadosProfissionaisRepository.php';

return $this->privates['App\Repository\DadosProfissionaisRepository'] = new \App\Repository\DadosProfissionaisRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
