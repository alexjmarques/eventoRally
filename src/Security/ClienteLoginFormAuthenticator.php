...
class ClienteLoginFormAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    {
        return 'cliente_login' === $request->attributes->get('_route')
    ...
    {
        return $this->urlGenerator->generate('cliente_login');
    }
}
