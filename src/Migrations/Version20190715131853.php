 ...
 */
final class Version20190715131853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE usuario_evento CHANGE data_pagamento data_pagamento DATETIME DEFAULT NULL, CHANGE status_pagamento status_pagamento VARCHAR(255) DEFAULT NULL, CHANGE code_pagamento code_pagamento VARCHAR(255) DEFAULT NULL, CHANGE objeto_pagamento objeto_pagamento LONGTEXT DEFAULT NULL');
